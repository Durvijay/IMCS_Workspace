...
public class ObjectFactory {
    ...
    private final static QName _Employee_QNAME = new QName("http://trng.imcs.xsd/employee", "Employee");
    private final static QName _Department_QNAME = new QName("http://trng.imcs.xsd/Department", "Department");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trng.imcs.xsd/employee", name = "Employee")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trng.imcs.xsd/Department", name = "Department")
