...
public class ObjectFactory {
    ...
    private final static QName _Customer_QNAME = new QName("http://imcs.customer.xsd/Customer", "Customer");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://imcs.customer.xsd/Customer", name = "Customer")
